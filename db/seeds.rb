...
Job.create!([
  {title: "Fender", description: "Re-Frett & Full Setup", status: "In Progress", user_id: 3, cost: 75.25},
  {title: "Gibson", description: "Re-String", status: "Ready for Pickup", user_id: 3, cost: 75.25},
  {title: "Taylor", description: "Full Setup", status: "In Progress", user_id: 4, cost: 60.25},
